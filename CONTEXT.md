...
- **AgentOutcome** — A structured interpretation of an **Agent's** execution. It distills raw terminal output and exit codes into actionable data like token usage, success status, and specific error classifications.
